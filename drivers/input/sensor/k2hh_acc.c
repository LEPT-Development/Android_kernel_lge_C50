...
static DEVICE_ATTR(value, S_IRUGO|S_IWUSR |S_IWGRP, attr_get_sensor_cal_data, NULL); //       
...
static DEVICE_ATTR(run_fast_calibration, S_IRUGO|S_IWUSR |S_IWGRP,   attr_get_fast_calibration, attr_set_fast_calibration);  //       
static DEVICE_ATTR(run_calibration, S_IRUGO|S_IWUSR |S_IWGRP,    attr_get_eeprom_writing, attr_set_eeprom_writing);          //       
static DEVICE_ATTR(fast_calibration_x, S_IRUGO|S_IWUSR |S_IWGRP, attr_get_fast_calibration_x, attr_set_fast_calibration_x);  //       
static DEVICE_ATTR(fast_calibration_y, S_IRUGO|S_IWUSR |S_IWGRP, attr_get_fast_calibration_y, attr_set_fast_calibration_y);  //       
static DEVICE_ATTR(fast_calibration_z, S_IRUGO|S_IWUSR |S_IWGRP, attr_get_fast_calibration_z, attr_set_fast_calibration_z);  //       
//SGS
